...
#    sql = '''INSERT INTO commentaire (date_publication, peinture_id, utilisateur_id, commentaire, valider) VALUES
#        ('2024-03-10', 1, 2, 'Très bonne peinture, je suis satisfait de mon achat.', 0),
#        ('2024-03-11', 2, 3, 'La couleur est magnifique, mais la peinture est un peu épaisse.', 1),
#        ('2024-03-12', 3, 2, 'Je recommande vivement cette peinture écologique, elle est excellente !', 0);'''
#    mycursor.execute(sql)
#
#    sql = '''INSERT INTO note (peinture_id, utilisateur_id, note) VALUES
#        (1, 2, 4),
#        (2, 3, 3),
#        (3, 2, 5);'''
#    mycursor.execute(sql)
